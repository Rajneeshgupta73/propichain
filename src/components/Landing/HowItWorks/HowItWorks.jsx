...
const HowItWorks = () => {
  return (
    <div className="mt-0 max-lg:pb-[500px]" id="howitworks">
      <div className="text-center max-w-xl 2xl:max-w-3xl mx-auto">
        <h2 className="uppercase">How It Works</h2>
        <h3 className="pt-6 pb-4 lg:py-8 2xl:py-3 font-bold leading-tight tracking-normal font-dmsans">
      ...
      <div className="flex items-center justify-between flex-col gap-10 mt-10 relative max-lg:w-[850px] lg:max-w-[1250px] 2xl:max-w-[1514px] mx-auto">
        <div>
          ...
          <h5 className="text-lg lg:text-2xl font-display font-normal uppercase pb-5 lg:pb-8">Future of ownership real estate</h5>
          <p className="pb-8 max-lg:text-base">All generating you a passive income</p>
          <Button
        ...
        <div>
          <div className="absolute top-[284px] lg:top-0 left-[100px] lg:-left-2 2xl:left-16 text-center">
            <div className="relative">
              <img src="/img/user1.png" alt="user" className="mx-auto max-lg:w-32 max-lg:h-32 max-lg:max-w-full width-max70 z-30 relative"/>
          ...
          <div  className="absolute top-[284px] lg:top-0 right-20 lg:-right-4 2xl:right-16 text-center">
            <div className="relative">
              <img src="/img/user2.png" alt="user" className="mx-auto max-lg:w-32 max-lg:h-32 max-lg:max-w-full width-max70 z-30 relative"/>
          ...
          <div className="absolute -bottom-[176px] lg:-bottom-28 2xl:-bottom-32 left-[258px] lg:left-[80px] 2xl:left-40 text-center">
            <div className="relative">
              <img src="/img/user3.png" alt="user" className="mx-auto  max-lg:w-32 max-lg:h-32 max-lg:max-w-full width-max70 relative z-30"/>
          ...
          <div className="absolute  -bottom-[176px] lg:-bottom-24 2xl:-bottom-32 right-[208px] lg:right-[82px] 2xl:right-40 text-center">
            <div className="relative">
              <img src="/img/user4.png" alt="user" className="mx-auto max-lg:w-32 max-lg:h-32 max-lg:max-w-full width-max70 relative z-30"/>
