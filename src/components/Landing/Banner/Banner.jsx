  ...
  return (
    <div className="px-10 py-8" id="home">
      ...
      <div className="flex max-lg:flex-wrap max-lg:justify-center">
        <div className="lg:basis-1/2 max-lg:mb-16">
          <div className="w-[450px] h-[450px] 2xl:w-[600px] 2xl:h-[600px] rounded-full bg-gray relative flex justify-center items-center">
            <div className="w-[372px] h-[372px] 2xl:w-[522px] 2xl:h-[522px] rounded-full border-[30px] border-white">
              <div className="absolute w-[900px] h-[450px] lg:h-[704px] -left-[67px] top-16 2xl:top-20">
                <img
        ...
        <div className="lg:basis-1/2 lg:pl-16 max-lg:text-center max-lg:flex max-lg:items-center max-lg:flex-col">
          <h3 className="textGradient uppercase pb-6 max-lg:text-xl">Tokenization</h3>
          <h1 className="text-3xl lg:text-[40px] 2xl:text-[74px] font-display uppercase leading-[36px] lg:leading-[46px] 2xl:leading-[88px] pb-4 2xl:max-w-[934px] max-2xl:max-w-[500px]">
          ...
          <div className="lg:max-w-xl mb-20">
            ...
            <div className="flex items-center gap-4 mt-8 mb-16 max-lg:justify-center">
              <Button
                label="How to Buy"
