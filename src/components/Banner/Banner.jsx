    ...
    <div className="px-10 py-8">
      ...
      <div className="flex">
        <div className="basis-1/2">
          <div className="w-[690px] h-[690px] rounded-full bg-gray relative flex justify-center items-center">
            <div className="w-[522px] h-[522px] rounded-full border-[40px] border-white">
                <div className="absolute w-[900px] h-[704px] -left-[67px] top-[117px]"><img src="/img/property_img.png" alt="banner_img" /> </div>
            </div>
          </div>
        </div>
        <div className="basis-1/2">
          <h3 className="textGradient uppercase pb-6">Tokenization</h3>
          <h1 className="text-[78px] font-display uppercase leading-[88px] pb-4 2xl:max-w-[934px]">
      ...
      <div className="flex items-center justify-between gap-4">
            <h4 className="text-2xl font-display font-normal uppercase">DeRent Platform</h4>
            <div>
          <Button
          label="Scroll Down"
          variant="secondary"
        ...
        <h4 className="text-2xl font-display font-normal uppercase">$DRT Token</h4>
        </div>
    </div>
  );
};
